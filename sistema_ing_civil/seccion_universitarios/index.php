					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
								<li><a href="documentacion_universitario/documentacion.php">Credencial de universitario</a></li>
								<li><a href="examenes/examen.php">ingresar a examen programado</a></li>
								<li><a href="documentacion/documentacion.php">Documentación</a></li>
								<li><a href="documentos_practicas/documentos_practicas.php">Ver Practicas</a></li>
								<li><a href="entrega_practicas/index.php">Presentar practicas</a></li>
								<li><a href="ver_notas/ver_notas.php">Ver notas</a></li>
<!-- 								
								<li><a href="agregar.php">agregar columnas</a></li> -->
								<!-- <li><a href="">Listas de estudiantes inscritos</a></li>
								<li><a href="">Listas de estudiantes inscritos en el semestre</a></li> -->
							</ul>
						</div>
					</nav>
				...
				<div class="container">
					<div class="row">
						<header class="heading-holder col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
							<br>
							<br>
							<h1 style="font-size: 50px;">Bienvenido <?php echo $_SESSION['universitario_nombre']; ?></h1>
							<br>
							<p>Bienvenido a la sección donde podras acceder a practicas en linea que dejan los diferentes docente de las materias que llevas en tu semestre, ademas de los examenes en linea.</p>
							<a href="../secion_docentes/documentacion_docentes/documentos_practicas/index.php">asignar trabajos</a>
						</header>
					</div>

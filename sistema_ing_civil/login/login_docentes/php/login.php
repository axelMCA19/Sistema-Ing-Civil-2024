...
if (empty($errores)) {
    try {
        ...
        $sql="SELECT * FROM docentes WHERE carnet=:carnet ";
        ...
        //los valores que estan despues del igual en los corchetes son de la base de datos
                ...
                $_SESSION['docente_nombre']=$user['nombres'];
                $_SESSION['docente_apellido']=$user['apellidos'];
        ...
        if ($login) {
            ...
            header("Location:../../../secion_docentes/docente.php");
        }else {
